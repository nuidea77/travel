...
export default function PageHero({
  ...
  return (
    <section className="relative isolate overflow-hidden">
      ...
      <div className="container-site relative py-16 text-center text-white lg:py-24">
        <h1 className="font-display text-3xl font-semibold tracking-tight lg:text-5xl">{title}</h1>
        {subtitle && (
